...
export function ProjectShareDialog({ open, onOpenChange, hasTimeline = true }: ProjectShareDialogProps) {
  ...
  useEffect(() => {
    if (open && hasTimeline && activeProject && !activeProject.shareSettings?.shareToken) {
