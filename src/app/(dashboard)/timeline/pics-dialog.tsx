                  ...
                  <div key={pic.id} className="flex items-center justify-between bg-muted/30 p-2 rounded border">
                    <div className="flex items-center gap-3 flex-1">
                      <input 
                        ...
                        title="Change PIC color"
                        className="w-7 h-7 rounded-full border cursor-pointer p-0 overflow-hidden bg-transparent shrink-0 [&::-webkit-color-swatch-wrapper]:p-0 [&::-webkit-color-swatch]:border-none [&::-webkit-color-swatch]:rounded-full"
                      />
